...
/**
 * Componente Confetti de Magic UI.
 * Origen: https://magicui.design/docs/components/confetti
 * Licencia: MIT, Copyright (c) Magic UI.
 *
 * Copiado del registro oficial con una sola modificación: se omite `ConfettiButton`,
 * que depende del componente `Button` de shadcn/ui, no usado en este proyecto.
 * El resto del código se conserva sin cambios para facilitar su actualización.
 */
